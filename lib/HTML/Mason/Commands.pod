...
scalar/list context.  See the Components/autohandlers section of the
...
forward relative path cannot be generated. See the Components/autohandlers
...
implemented as a DBM database. See the Components/data caching
...
See the Components/filtering section of the I<Component Developer's Guide>
...
Components/dhandlers section of the I<Component Developer's Guide>
for examples.
