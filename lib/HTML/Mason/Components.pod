...
sec, seconds, min, minutes, hours, days, weeks, or months. You can
also use the first letter or singular form of any of these. (This
notation was adapted from Sullivan Beck's Date::Manip package.)
E.g. "30sec", "10min", "1hour", "4h".
...
Examples:
    ...
    mc_cache(action=>'store', expire_in=>'15min');
...
Example:
    ...
    # expire the cache if 'myfile' has changed since the cache was written
